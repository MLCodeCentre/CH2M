function images = getImages(easting, northing, road, years, camera, min_distance, max_distance)
...
for year_ind = 1:num_years
    ...
    images = [images; table(File_Name, Year, Distance, Northing, Easting, Heading)];
end
