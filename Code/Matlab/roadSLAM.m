...
for D = 6:2:20
    ...
    lb = [-0.5,-0.5,-0.5,0,0,0];
    ub = [0.5,0.5,0.5,2,2,3];
    init = [0,0,0,1,1,2];
    [X,resnorm,residual,exitflag,output,lambda,jacobian]  = lsqnonlin(@(params)cameraEquationsSLAM(params,U,V,X,Y),init,lb,ub);
    X
